...
- Membership: Implementing the all-to-all heartbeating membership protocol that satisfies completeness all the time (for joins and failures) and accuracy when there are no message delays or losses (high accuracy when there are losses or delays).
